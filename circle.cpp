                                                 ...
                                                 double x2, double y2, double r2)
{
    ...
    */
    ...
    cout<<"INTERSECTION Circle1 AND Circle2: ( "<< intersectionPoint1_x <<","<< intersectionPoint1_y << ")" << " AND (" << intersectionPoint2_x << "," << intersectionPoint2_y << ")";
    ...
    if(abs(d1 - r2) < EPSILON) {
        ...
        cout<<"INTERSECTION Circle1 AND Circle2 AND Circle3: (" << intersectionPoint2_x << "," << intersectionPoint2_y << ")"; //here was an error
    }
    else {
...
alculateThreeCircleIntersection(-2.0, 0.0, 2.0, // circle 1 (center_x, center_y, radius)
